    ...
    <body>
        ...
        <script src="js/main.js"></script>
            ...
            <center>
                ...
                <h2 align="center" style="color: green">Welcome To File Request </h2>
                
               <!-- <form action="filerequest1.jsp" method="get"> -->
            ...
            PreparedStatement pst=con.prepareStatement("select * from uploadfile");
            ...
            while(rs.next())
            {
                ...
                <tr>
                   ...
                   <!-- <td><%=rs.getString("keyword1")%></td>
                    ...
                    <td><a href="filerequest1.jsp?filename=<%=rs.getString("filename")%>">Request</a> </td>
