    ...
    <body>
        ...
        <script src="js/main.js"></script>
            ...
            <center>
                ...
                <form action="searchfile1.jsp" method="get">
                
                <h2 align="center" style="color: #4cae4c">Type Here To Search...</h2>
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <input type="radio" name="filename" >File Name Search
                        </td>
                    </tr>
                     ...
                     <tr>
                        <td>
                            <input type="radio" name="keyword" >Key Word Search
                        </td>
                    </tr>
                    ...
                    <!--
                      ...
                      <tr>
                        <td>
                            <input type="radio" name="ranked" />Ranked Search
                            <br><br><br> </td>
                    </tr>
