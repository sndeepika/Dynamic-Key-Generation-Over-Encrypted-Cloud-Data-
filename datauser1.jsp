        ...
        <script src="js/main.js"></script>
            ...
            <center>
               ...
               String password=request.getParameter("password");
                   ...
                   if((type.equalsIgnoreCase("Admin")) && (username.equalsIgnoreCase("owner")) && password.equalsIgnoreCase("owner"))
                {
                  %>  
                  <jsp:forward page="Admin.jsp"/>
                    <%
                             ...
                             else if((type.equalsIgnoreCase("Cloud")) && (username.equalsIgnoreCase("cloud")) && password.equalsIgnoreCase("cloud"))
{
%>
...
else if(type.equalsIgnoreCase("User"))
{
               ...
               if(rs.next())  
               {
                  ...
                  <jsp:forward page="datauserhome.jsp"/>
                   <%
               }
               ...
               else
               {
                   ...
                   <h2 align="center">Please Check Username and Password.......</h2>
                   <%
                   }
