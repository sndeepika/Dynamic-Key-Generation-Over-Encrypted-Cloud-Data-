    ...
    <body>
        ...
        <script src="js/main.js"></script>
            ...
            <center>
               ...
               PreparedStatement pst1=con.prepareStatement("select filename from request where filename=?");
               ...
               String query="select u.fileid,u.filename,u.keyword1,u.keyword2,u.gkey,r.datetime from uploadfile u,request r where u.filename='"+file+"' and r.filename='"+file+"' ";
