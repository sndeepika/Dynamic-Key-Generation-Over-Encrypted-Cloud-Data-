               ...
               <% 
                ...
                String DateToStr = DateFormat.getInstance().format(curDate);
                 ...
                 count++;
                  ...
                  PreparedStatement pst=con.prepareStatement("insert into request (username,filename,count) values(?,?,?)");
                  ...
                  PreparedStatement pst1=con.prepareStatement("update register set requestcount=requestcount+1 where username=?");
