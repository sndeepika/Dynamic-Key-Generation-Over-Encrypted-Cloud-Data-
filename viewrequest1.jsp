    ...
    <body>
        ...
        <script src="js/main.js"></script>
            ...
            <center>
               ...
               String query="select f.fileid,f.filename,r1.userid,r1.username,r2.datetime from uploadfile f,register r1,request r2 where f.filename=r2.filename and r1.username='"+username+"'";
