...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <script src="js/main.js"></script>
            ...
            <center>
                <form action="userdetail1.jsp" method="post">
              
                <h2 style="color: red">All Users Information</h2>
           ...
           PreparedStatement pst=con.prepareStatement("select * from register");
            ...
            for(int i=1;i<=count+1;i++)
            {
                if(i==count+1)
                {
              out.println("<th align='center'><a href='DeleteUser.jsp?userid="+rs.getString("userid")+"'>DeleteUser</a></th>");      
                }
                else
                {
                    if(!rsmd.getColumnName(i).equalsIgnoreCase("password"))
                    {
              out.println("<th align='center'>"+rs.getString(i)+"</th>"); 
                    }
                }
                ...
                %>    
                                ...
                                <!--<table>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <input type="submit" value="Submit" style="color: #00A2DE"/>
                                        </td>
                                    </tr>
                                </table>-->
