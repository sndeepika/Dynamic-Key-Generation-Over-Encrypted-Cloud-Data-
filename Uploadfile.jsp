    ...
    <body>
        ...
        <tr>
            ...
            <td><input type="text" id="fileid" name="fileid" value="<%=fileid%>" class="text" size="20"  readonly=""/>
                <a href="../src/java/com/util/uploadServlet.java"></a>
                <br><br> </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <center>
                    ...
                    <h3 style="color: blue">File Information</h3><br>
                    
                    <table border="2">
                        
                        <tr>
                             <th style="color: red">View Encrypted Data&nbsp;&nbsp;</th>
                            <th style="color: red">Delete File&nbsp;&nbsp;</th>
                            <th style="color: red">File Id&nbsp;&nbsp;</th>
                            <th style="color: red">File Name&nbsp;&nbsp;</th>
                            <th style="color: red">Index1&nbsp;&nbsp;</th>
                            <th style="color: red">Index2&nbsp;&nbsp;</th>
                        ...
                        while(rs1.next())
                        {
                            ...
                            <tr>
                 <td> <a href="ViewEncryptedData.jsp?fileid=<%=rs1.getString("fileid")%>">View Encrypted Data</a></td>
                
                                <td> <a href="deletefile.jsp?fileid=<%=rs1.getString("fileid")%>&filename=<%=rs1.getString("filename")%>">Delete</a></td>
